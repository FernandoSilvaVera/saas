...
function recordarUltimaPaginaVisitada() {
	...
	if (paginaGuardada != false && recuperarPaginaGuardada !== "no-recuperar") {
		sessionStorage.setItem('UPV_ui1_' + rutaBase + '', 'no-recuperar')
		var toastHTML = '<span class="toast-ultima-pagina" onclick="window.location=\'' + paginaGuardada + '\'">Last visited page</span><span onclick="Materialize.Toast.removeAll()"><i class="material-icons" style="font-size:medium;margin:10px;cursor:pointer;">close</i></span>';
...
$('.componenteSabiasQue').each(function () {
	...
	selectorIncorporarComponente.after('<div class="envoltorioComponenteFlotante componenteSabiasQueFlotante componenteIzquierda"><a class="modal-trigger" href="#modalComponente' + cadenaAzar + '"><img src="imagenes/componentes/sabiasQue.png" alt="Did you know?" class="imagenComponenteFlotante"></a></div><div id="modalComponente' + cadenaAzar + '" class="modal modalComponente"><div class="valign-wrapper"><img src="imagenes/componentes/sabiasQue.png" alt="Did you know?" class="imagenComponenteFlotante"><span style="margin-left:10px;"><strong>Did you know?</strong></div></p>' + recuperarContenido + '</div>')
	$(this).remove()
});
$('.componenteRecuerda').each(function () {
	...
	cadenaAzar = Math.random().toString(36).substring(7)
	selectorIncorporarComponente = selectorSuperior($(this))
	selectorIncorporarComponente.after('<div class="envoltorioComponenteFlotante componenteRecuerdaFlotante componenteIzquierda"><a class="modal-trigger" href="#modalComponente' + cadenaAzar + '"><img src="imagenes/componentes/recuerda.png" alt="Remember" class="imagenComponenteFlotante"></a></div><div id="modalComponente' + cadenaAzar + '" class="modal modalComponente"><div class="valign-wrapper"><img src="imagenes/componentes/recuerda.png" alt="Remember" class="imagenComponenteFlotante"><span style="margin-left:10px;"><strong>Remember</strong></div></p>' + recuperarContenido + '</div>')
	$(this).remove()
});
...
$('.componenteLlegaMasLejos').each(function () {
	...
	cadenaAzar = Math.random().toString(36).substring(7)
	selectorIncorporarComponente = selectorSuperior($(this))
	selectorIncorporarComponente.after('<div class="envoltorioComponenteFlotante componenteLlegaMasLejosFlotante componenteIzquierda"><a class="modal-trigger" href="#modalComponente' + cadenaAzar + '"><img src="imagenes/componentes/llegaMasLejos.png" alt="Go further" class="imagenComponenteFlotante"></a></div><div id="modalComponente' + cadenaAzar + '" class="modal modalComponente"><div class="valign-wrapper"><img src="imagenes/componentes/llegaMasLejos.png" alt="Go further" class="imagenComponenteFlotante"><span style="margin-left:10px;"><strong>Go further</strong></div></p>' + recuperarContenido + '</div>')
	$(this).remove()
});
...
$('.componenteEnLaOnda').each(function () {
	...
	cadenaAzar = Math.random().toString(36).substring(7)
	selectorIncorporarComponente = selectorSuperior($(this))
	selectorIncorporarComponente.after('<div class="envoltorioComponenteFlotante componenteEnLaOndaFlotante componenteIzquierda"><a class="modal-trigger" href="#modalComponente' + cadenaAzar + '"><img src="imagenes/componentes/enLaOnda.png" alt="Listen" class="imagenComponenteFlotante"></a></div><div id="modalComponente' + cadenaAzar + '" class="modal modalComponente"><div class="valign-wrapper"><img src="imagenes/componentes/enLaOnda.png" alt="Listen" class="imagenComponenteFlotante"><span style="margin-left:10px;"><strong>Listen</strong></div></p>' + recuperarContenido + '</div>')
	$(this).remove()
});
...
$('.componenteNota').each(function () {
	...
	cadenaAzar = Math.random().toString(36).substring(7)
	selectorIncorporarComponente = selectorSuperior($(this))
	selectorIncorporarComponente.after('<div class="envoltorioComponenteFlotante componenteNotaFlotante componenteDerecha"><a class="modal-trigger" href="#modalComponente' + cadenaAzar + '"><img src="imagenes/componentes/nota.png" alt="Note" class="imagenComponenteFlotante"></a></div><div id="modalComponente' + cadenaAzar + '" class="modal modalComponente"><div class="valign-wrapper"><img src="imagenes/componentes/nota.png" alt="Note" class="imagenComponenteFlotante"><span style="margin-left:10px;"><strong>Note</strong></div></p>' + recuperarContenido + '</div>')
	$(this).remove()
});
$('.componenteViaja').each(function () {
	...
	cadenaAzar = Math.random().toString(36).substring(7)
	selectorIncorporarComponente = selectorSuperior($(this))
	selectorIncorporarComponente.after('<div class="envoltorioComponenteFlotante componenteViajaFlotante componenteDerecha"><a class="modal-trigger" href="#modalComponente' + cadenaAzar + '"><img src="imagenes/componentes/viaja.png" alt="Travel" class="imagenComponenteFlotante"></a></div><div id="modalComponente' + cadenaAzar + '" class="modal modalComponente"><div class="valign-wrapper"><img src="imagenes/componentes/viaja.png" alt="Travel" class="imagenComponenteFlotante"><span style="margin-left:10px;"><strong>Travel</strong></div></p>' + recuperarContenido + '</div>')
	$(this).remove()
});
$('.componenteConocesA').each(function () {
	...
	cadenaAzar = Math.random().toString(36).substring(7)
	selectorIncorporarComponente = selectorSuperior($(this))
	selectorIncorporarComponente.after('<div class="envoltorioComponenteFlotante componenteConocesAFlotante componenteDerecha"><a class="modal-trigger" href="#modalComponente' + cadenaAzar + '"><img src="imagenes/componentes/conocesA.png" alt="Do you know...?" class="imagenComponenteFlotante"></a></div><div id="modalComponente' + cadenaAzar + '" class="modal modalComponente"><div class="valign-wrapper"><img src="imagenes/componentes/conocesA.png" alt="Do you know...?" class="imagenComponenteFlotante"><span style="margin-left:10px;"><strong>Do you know...?</strong></div></p>' + recuperarContenido + '</div>')
	$(this).remove()
});
$('.componenteQuienDijo').each(function () {
	...
	if (comprobarImagen > 0) {
		...
		$(this).after('<div class="envoltorioComponenteFlotante componenteQuienDijoFlotante componenteDerecha"><a class="modal-trigger" href="#modalComponente' + cadenaAzar + '"><img src="imagenes/componentes/quienDijo.png" alt="Who said...?" class="imagenComponenteFlotante"></a></div><div id="modalComponente' + cadenaAzar + '" class="modal modalComponente"><div class="valign-wrapper"><img src="imagenes/componentes/quienDijo.png" alt="Who said...?" class="imagenComponenteFlotante"><span style="margin-left:10px;"><strong>Who said...?</strong></div></p>' + recuperarContenido + '</div>')
...
$(document).ready(function () {
	...
	$('.espacioContenido').find('img').each(function () {
		...
		regexAlt365 = /[t|T]itle:(.*)?[d|D]escription:(.*)/g
	...
	if (existenciaActividades === true) {
		$('h1:first').before('<div class="disparadorActividades"><a class="btn-floating btn-large waves-effect waves-light modal-trigger teal tooltipped " data-position="top" data-delay="50" data-tooltip="Activities" href="#modalActividades"><i class="material-icons iconoComponenteVisible iconoActividades">touch_app</i></a></div>')
		$('body').append('<div class="avisoActividades" style="position:fixed; bottom:0;width:100%;background-color:#323232; padding:10px 25px;color:white;z-index:99;text-align:center;z-index:999">Dont\' forget the activities! <i class="material-icons iconoComponenteVisible iconoActividades">touch_app</i> <i class="material-icons tiny cerrarAvisoActividades" style="float:right;position:relative;top:-5px;cursor:pointer;">close</i></div>')
		...
		$('.contenidoActividades').after('<div id="modalActividades" class="modal"><div class="modal-content"><h4>Activities</h4><div id="envoltorioModalActividades"></div></div><div class="modal-footer"><a class="modal-action modal-close waves-effect btn-flat">Close</a></div></div>');
		$('.contenidoActividades').find('h5').each(function () {
			recogerTexto = $(this).text().replace(/\s+/g, '');
			recogerTitulo = document.title.replace(/\s+/g, '');
			...
			if (recogerTexto === recogerTitulo || obtenerNumeroPantalla === obtenerNumeroPagina) {
				...
				if (tipoActividad === 'HUECOS') {
					...
					if (longitudTabla === 2) {
						$('#envoltorioModalActividades').before('<div class="envoltorioActividad envoltorioActividadHuecos"><p><b>Fill the gaps</b></p><div class="actividadRellenarHuecos">' + contenidoActividad + '<div class="botonesDerecha"><a class="btn-floating green disparadorComprobarHuecos waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Check"><i class="material-icons">done</i></a><a class="btn-floating orange darken-1 disparadorSolucionarHuecos waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Solve"><i class="material-icons">done_all</i></a><a class="btn-floating red darken-1 disparadorBorrarHuecos waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Reset"><i class="material-icons">replay</i></a><p class="numeroAciertosHuecos oculto">Your score is <span class="aciertosHuecos"></span> of <span class="totalHuecos"></span></p></div></div></div>')
					} else if (longitudTabla === 3) {
						recogerRetroalimentacion = $(this).nextAll('table:first').find('td:last').html();
						$('#envoltorioModalActividades').before('<div class="envoltorioActividad envoltorioActividadHuecos"><p><b>Fill the gaps</b></p><div class="actividadRellenarHuecos">' + contenidoActividad + '<div class="botonesDerecha"><a class="btn-floating green disparadorComprobarHuecos waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Check"><i class="material-icons">done</i></a><a class="btn-floating orange darken-1 disparadorSolucionarHuecos waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Solve"><i class="material-icons">done_all</i></a><a class="btn-floating red darken-1 disparadorBorrarHuecos waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Reset"><i class="material-icons">replay</i></a><p class="numeroAciertosHuecos oculto">Your score is <span class="aciertosHuecos"></span> of <span class="totalHuecos"></span></p><div class="retroalimentacionCorrecta retroalimentacionHuecosDesplegable oculto">' + recogerRetroalimentacion + '</div></div></div></div>')
					}
				} else if (tipoActividad === 'DESPLEGABLE') {
					longitudTabla = $(this).nextAll('table:first').find('td').length;
					if (longitudTabla === 2) {
						$('#envoltorioModalActividades').before('<div class="envoltorioActividad envoltorioActividadDesplegable"><p><b>Dropdown menu</b></p><div class="actividadDesplegable">' + contenidoActividad + '<div class="botonesDerecha"><a class="btn-floating green disparadorComprobarDesplegable waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Check"><i class="material-icons">done</i></a><a class="btn-floating orange darken-1 disparadorSolucionarDesplegable waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Solve"><i class="material-icons">done_all</i></a><a class="btn-floating red darken-1 disparadorBorrarDesplegable waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Reset"><i class="material-icons">replay</i></a><p class="numeroAciertosDesplegable oculto">Your score is <span class="aciertosDesplegable"></span> of <span class="totalDesplegable"></span></p></div></div></div>')
					} else if (longitudTabla === 3) {
						recogerRetroalimentacion = $(this).nextAll('table:first').find('td:last').html();
						$('#envoltorioModalActividades').before('<div class="envoltorioActividad envoltorioActividadDesplegable"><p><b>Dropdown menu</b></p><div class="actividadDesplegable">' + contenidoActividad + '<div class="botonesDerecha"><a class="btn-floating green disparadorComprobarDesplegable waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Check"><i class="material-icons">done</i></a><a class="btn-floating orange darken-1 disparadorSolucionarDesplegable waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Solve"><i class="material-icons">done_all</i></a><a class="btn-floating red darken-1 disparadorBorrarDesplegable waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Reset"><i class="material-icons">replay</i></a><p class="numeroAciertosDesplegable oculto">Your score is <span class="aciertosDesplegable"></span> of <span class="totalDesplegable"></span></p><div class="retroalimentacionCorrecta retroalimentacionHuecosDesplegable oculto">' + recogerRetroalimentacion + '</div></div></div></div>')
					}
				} else if (tipoActividad === 'DESPLEGABLE_SIMPLE') {
					longitudTabla = $(this).nextAll('table:first').find('td').length;
					if (longitudTabla === 2) {
						$('#envoltorioModalActividades').before('<div class="envoltorioActividad envoltorioActividadDesplegableSimple"><p><b>Actividad con desplegables</b></p><div class="actividadDesplegableSimple">' + contenidoActividad + '<div class="botonesDerecha"><a class="btn-floating green disparadorComprobarDesplegableSimple waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Comprobar"><i class="material-icons">done</i></a><a class="btn-floating orange darken-1 disparadorSolucionarDesplegableSimple waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Resolver"><i class="material-icons">done_all</i></a><a class="btn-floating red darken-1 disparadorBorrarDesplegableSimple waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Reiniciar"><i class="material-icons">replay</i></a><p class="numeroAciertosDesplegable oculto">Your score is<span class="aciertosDesplegable"></span> of <span class="totalDesplegable"></span></p></div></div></div>')
					} else if (longitudTabla === 3) {
						recogerRetroalimentacion = $(this).nextAll('table:first').find('td:last').html();
						$('#envoltorioModalActividades').before('<div class="envoltorioActividad envoltorioActividadDesplegableSimple"><p><b>Actividad con desplegables</b></p><div class="actividadDesplegableSimple">' + contenidoActividad + '<div class="botonesDerecha"><a class="btn-floating green disparadorComprobarDesplegableSimple waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Comprobar"><i class="material-icons">done</i></a><a class="btn-floating orange darken-1 disparadorSolucionarDesplegableSimple waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Resolver"><i class="material-icons">done_all</i></a><a class="btn-floating red darken-1 disparadorBorrarDesplegableSimple waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Reiniciar"><i class="material-icons">replay</i></a><p class="numeroAciertosDesplegable oculto">Your score is<span class="aciertosDesplegable"></span> of <span class="totalDesplegable"></span></p><div class="retroalimentacionCorrecta retroalimentacionHuecosDesplegable oculto">' + recogerRetroalimentacion + '</div></div></div></div>')
					}
					...
					$('#envoltorioModalActividades').before('<div class="envoltorioActividad envoltorioActividadEleccionMultiple"><p><b>Multiple choice</b></p><div class="identificadorActividadEleccionMultiple actividadEleccionMultiple' + numeroAleatorio + '"><div class="botonesDerecha"><a class="btn-floating green disparadorComprobarEleccion waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Check"><i class="material-icons">done</i></a><a class="btn-floating orange darken-1 disparadorSolucionarEleccion waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Solve"><i class="material-icons">done_all</i></a><a class="btn-floating red darken-1 disparadorBorrarEleccion waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Reset"><i class="material-icons">replay</i></a></div></div></div>')
					...
					contenidoTablaEleccionMultiple = $(this).nextAll('table:first').find('tr').each(function () {
						...
						if (contador === 0) {
							$('#eleccionMultipleForm' + numeroAleatorio + '').after('<div class="retroalimentacionIncorrecta" style="display:none;"><span><i class="material-icons">mood_bad</i> <strong><span style="position:relative;top:-5px;">Wrong answer</span></strong></span></div>')
							$('#eleccionMultipleForm' + numeroAleatorio + '').after('<div class="retroalimentacionCorrecta" style="display:none;"><span><i class="material-icons" style="color:#0A8A0A">mood</i> <strong><span style="position:relative;top:-5px;">Right answer</span></strong></span><br/>' + contenidoTablaEleccionMultipleRetroalimentacion + '</div>')
						}
						contador++;
					});
					...
					$('#envoltorioModalActividades').before('<div class="envoltorioActividad envoltorioActividadSeleccionMultiple"><p><b>Multiple choice</b></p><div class="identificadorActividadSeleccionMultiple actividadSeleccionMultiple' + numeroAleatorio + '"><div class="botonesDerecha"><a class="btn-floating green disparadorComprobarSeleccion waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Check"><i class="material-icons">done</i></a><a class="btn-floating orange darken-1 disparadorSolucionarSeleccion waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Solve"><i class="material-icons">done_all</i></a><a class="btn-floating red darken-1 disparadorBorrarSeleccion waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Reset"><i class="material-icons">replay</i></a></div></div></div>')
					...
					contenidoTablaSeleccionMultiple = $(this).nextAll('table:first').find('tr').each(function () {
						...
						if (contador === 0) {
							$('#seleccionMultipleForm' + numeroAleatorio + '').after('<div class="retroalimentacionIncorrecta" style="display:none;"><span><i class="material-icons">mood_bad</i> <strong><span style="position:relative;top:-5px;">Wrong answer</span></strong></span></div>')
							$('#seleccionMultipleForm' + numeroAleatorio + '').after('<div class="retroalimentacionCorrecta" style="display:none;"><span><i class="material-icons" style="color:#0A8A0A">mood</i> <strong><span style="position:relative;top:-5px;">Right answer</span></strong></span><br/>' + contenidoTablaSeleccionMultipleRetroalimentacion + '</div>')
						}
						contador++;
					});
					...
					$('#envoltorioModalActividades').before('<div class="envoltorioActividad envoltorioActividadVerdaderoFalso"><p><b>True or false</b></p><div class="identificadorActividadVerdaderoFalso actividadVerdaderoFalso' + numeroAleatorio + '"></div></div>')
					...
					for (i = 0; i < numeroPreguntasVerdaderoFalso; i++) {
						...
						$('#eleccionVerdaderoFalsoForm' + numeroAleatorio + '_' + contador + '').append('<p>' + contenidoPreguntaVerdaderoFalso + '<p><input name="eleccionVerdaderoFalsoForm' + numeroAleatorio + '_' + contador + '" type="radio" id="opcionRespuestaVerdadero' + numeroAleatorio + '_' + contador + '" data-debeseleccionarse="' + contenidoRespuestaVerdaderoFalso + '"/><label class="labelPreguntaVerdadero" for="opcionRespuestaVerdadero' + numeroAleatorio + '_' + contador + '">True</label></p><p><input name="eleccionVerdaderoFalsoForm' + numeroAleatorio + '_' + contador + '" type="radio" id="opcionRespuestaFalso' + numeroAleatorio + '_' + contador + '" data-debeseleccionarse="' + contenidoRespuestaVerdaderoFalso + '"/><label class="labelPreguntaFalso" for="opcionRespuestaFalso' + numeroAleatorio + '_' + contador + '">False</label></p><div class="retroalimentacionIncorrecta" style="display:none;"><span><i class="material-icons">mood_bad</i> <strong><span style="position:relative;top:-5px;">Wrong answer</span></strong></span></div><div class="retroalimentacionCorrecta" style="display:none;"><span><i class="material-icons" style="color:#0A8A0A">mood</i> <strong><span style="position:relative;top:-5px;">Right answer</span></strong></span><br/>' + contenidoRetroalimentacionVerdaderoFalso + '</div>')
						$('#eleccionVerdaderoFalsoForm' + numeroAleatorio + '_' + contador + '').append('<div class="botonesDerecha"><a class="btn-floating green disparadorComprobarVerdaderoFalso waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Check"><i class="material-icons">done</i></a><a class="btn-floating orange darken-1 disparadorSolucionarVerdaderoFalso waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Solve"><i class="material-icons">done_all</i></a><a class="btn-floating red darken-1 disparadorBorrarVerdaderoFalso waves-effect waves-light tooltipped" data-position="top" data-delay="50" data-tooltip="Reset"><i class="material-icons">replay</i></a></div>')
						contador++;
					}
					...
					$('.disparadorComprobarVerdaderoFalso').each(function () {
						$(this).click(function () {
							...
							if ((debeSeleccionarse === "T") && (respuestaSeleccionada === "True")) {
							...
							else if ((debeSeleccionarse === "F") && (respuestaSeleccionada === "False")) {
								$(this).parents('form:first').find('.retroalimentacionCorrecta:first').hide()
								$(this).parents('form:first').find('.retroalimentacionIncorrecta:first').hide()
								$(this).parents('form:first').find('.retroalimentacionCorrecta:first').show()
							}
					...
					columnaOpciones = '<div class="col l12 s12">'+posibleEnunciadoRelacion+'</div><div class="col l6 s12">'+columnaOpcionesPrevio+'</div>'
					...
					columnaRespuestas = '<div class="row"><div class="col l6 s12">'+columnaRespuestasPrevio+'</div></div>'
...
$(document).ready(function () {
	...
	$('.disparadorActividades').click(function () {
		...
		if (numeroActividadesEleccionMultiple > 1) {
			...
			$('#modalActividades').find('h4:first').after('<div class="envoltorioActividad"><p><strong>Multiple choice</strong></p>' + obtenerCodigoDepuradoEleccionMultiple + '</div>')
		...
		if (numeroActividadesSeleccionMultiple > 1) {
			...
			$('#modalActividades').find('h4:first').after('<div class="envoltorioActividad"><p><strong>Multiple choice</strong></p>' + obtenerCodigoDepuradoSeleccionMultiple + '</div>')
		...
		if (comprobarRegexNotasPie === true) {
			...
			$("#envoltorioNotasPie").load(direccionNotas + ' .footnotes', function () {
				...
				$('.footnote-ref').each(function () {
					numeroNotaPie = $(this).children('sup').text();
				...
				for (incrementadorNotas = 0; incrementadorNotas < arrayNotasPiePagina.length; incrementadorNotas++) {
					...
					recuperarContenido = $('#envoltorioNotasPie').find('ol').find('li').eq(numeroBusqueda).text();
					$('#envoltorioNotasPie').append('<p>' + arrayNotasPiePagina[incrementadorNotas] + '.' + recuperarContenido + '</p>')
				}
			})
			$('.footnote-ref').each(function () {
	...
	regexApartadoRecursosBibliograficos = /.*?eference.*/
