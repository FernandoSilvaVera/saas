...
! function() {
	...
	Annotator = function(_super) {
			...
			this.viewer.hide().on("edit", this.onEditAnnotation).on("delete", this.onDeleteAnnotation).addField({
				load: function(field, annotation) {
					if (annotation.text) {
						...
						$(field).html("<i>" + _t("Ningún comentario guardado") + "</i>")
					}
		...
		Annotator.prototype.highlightRange = function(normedRange, cssClass) {
			...
			if (forzarSubrayado === true) {
				if (cssClass == null) {
				cssClass = "annotator-hl forzarSubrayado"
			}
			}
			else {			
			if (cssClass == null) {
	...
	Annotator.Viewer = function(_super) {
		...
		Viewer.prototype.html = {
			...
			item: '<li class="annotator-annotation annotator-item">\n  <span class="annotator-controls">\n    <a href="#" title="View as webpage" class="annotator-link">View as webpage</a>\n    <a class="annotator-edit" title="Editar" style="cursor:pointer;"><i class="material-icons">edit</i></a>\n <a  class="annotator-delete" title="Eliminar" style="cursor:pointer;"><i class="material-icons">delete</i></a>\n  </span>\n</li>'
		};
